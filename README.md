...
A modern React application built with Vite that helps users find and request blood donors quickly and efficiently. This app demonstrates filtering, sorting, searching, and state management in React.
...
- Maps user data to donor objects with additional fields (blood group, availability)
- Blood groups are assigned randomly based on user ID
...
- Add more detailed donor profiles
